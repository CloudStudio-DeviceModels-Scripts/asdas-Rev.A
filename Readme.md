...
# Parsing Script – asdas - Rev. A

This **Parsing** script is designed for the **asdas** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – asdas Rev. A

Este script de **Parsing** está diseñado para el modelo **asdas** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
